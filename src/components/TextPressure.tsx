...
const TextPressure: FC<PropsWithChildren<TextPressureProps>> = ({
    text = 'Rohith',
    // Using a standard, high-quality variable font for better compatibility
    fontFamily = '"Inter VF", sans-serif',
    fontUrl = 'https://rsms.me/inter/font-files/Inter-VariableFont_slnt,wght.woff2',
    width = true,
    weight = true,
    italic = true,
    alpha = false,
