...
import RealTimeClock from "@/components/RealTimeClock"; // 1. Import the new clock component
...
// --- The Interactive Name Component ---
...
// A small style component to add animations.
  ...
  return (
    <>
      ...
      >
        ...
        {/* 2. The RealTimeClock is now positioned in the top-right corner */}
        ...
        <div className="container max-w-6xl mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <h1 className="mb-6">
              <span className="block font-display font-bold text-5xl md:text-6xl lg:text-7xl text-black dark:text-white tracking-wide transition-colors duration-300">
                Hi, I'm
              </span>
              <span className="block font-display text-7xl md:text-9xl lg:text-[10rem] font-bold text-gradient-shimmer leading-tight animate-slide-in">
                <InteractiveName text="Rohith" />
              </span>
            </h1>
